...
module.exports = {
  ...
  bodyBgImg: ['/img/bg/4.jpg', '/img/bg/5.jpg'], // body背景大图，默认无。 单张图片 String || 多张图片 Array, 多张图片时每隔15秒换一张。
  ...
  author: {
    ...
    name: 'docker', // 必需
    // link: 'https://github.com/987938582', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/987938582/blog',
      },
      {
  ...
  footer: {
    ...
    copyrightInfo: '博客模板 | <a href="#" target="_blank">MIT License</a>', // 版权信息，支持a标签
  },
